...
class PreviousAgentStart(Observations):
    """ Function that returns the observation of an agent based on 
    the number of agents that have the same origin - destination
    and start time inside a specific threshold. """
