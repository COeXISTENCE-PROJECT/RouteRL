# Medium-Sized Network: AV Behaviors and Collaborative MARL with TorchRL

> In this tutorial, agents navigate a medium-sized network. The default origin and destination points are specified in [`routerl/networks/default_ods.json`](../../routerl/networks/default_ods.json) and can be customized. We also define AV behaviors through their reward formulation and implement their learning process with [TorchRL](https://github.com/pytorch/rl).
